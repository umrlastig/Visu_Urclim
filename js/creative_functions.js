...
export function create_squeletton(MesoNH_O_array,MesoNH_U_array,MesoNH_V_array,grid,id_sbl_array,id_meso_array,temperature_scale,THAT,THAT_W,HCanopy,HCanopy_w){
    ...
    for(var m=0; m<id_sbl_array.length; m++){
        for(var j=0; j<nj; j++){
            for(var i=0; i<ni; i++){
				...
				//up
                coord_array.push(x_1*general_config.cst_X); coord_array.push(z_1*general_config.cst_Z); coord_array.push(-y_1*general_config.cst_Y);
				coord_array.push(x_2*general_config.cst_X); coord_array.push(z_2*general_config.cst_Z); coord_array.push(-y_2*general_config.cst_Y);
				
				coord_array.push(x_2*general_config.cst_X); coord_array.push(z_2*general_config.cst_Z); coord_array.push(-y_2*general_config.cst_Y);
				coord_array.push(x_3*general_config.cst_X); coord_array.push(z_3*general_config.cst_Z); coord_array.push(-y_3*general_config.cst_Y);
				
				coord_array.push(x_3*general_config.cst_X); coord_array.push(z_3*general_config.cst_Z); coord_array.push(-y_3*general_config.cst_Y);
				coord_array.push(x_4*general_config.cst_X); coord_array.push(z_4*general_config.cst_Z); coord_array.push(-y_4*general_config.cst_Y);
				
				coord_array.push(x_4*general_config.cst_X); coord_array.push(z_4*general_config.cst_Z); coord_array.push(-y_4*general_config.cst_Y);
				coord_array.push(x_1*general_config.cst_X); coord_array.push(z_1*general_config.cst_Z); coord_array.push(-y_1*general_config.cst_Y);
                
				//down
				coord_array.push(x_5*general_config.cst_X); coord_array.push(z_5*general_config.cst_Z); coord_array.push(-y_5*general_config.cst_Y);
				coord_array.push(x_6*general_config.cst_X); coord_array.push(z_6*general_config.cst_Z); coord_array.push(-y_6*general_config.cst_Y);
				                                                                                                            
				coord_array.push(x_6*general_config.cst_X); coord_array.push(z_6*general_config.cst_Z); coord_array.push(-y_6*general_config.cst_Y);
				coord_array.push(x_7*general_config.cst_X); coord_array.push(z_7*general_config.cst_Z); coord_array.push(-y_7*general_config.cst_Y);
				                                                                                                            
				coord_array.push(x_7*general_config.cst_X); coord_array.push(z_7*general_config.cst_Z); coord_array.push(-y_7*general_config.cst_Y);
				coord_array.push(x_8*general_config.cst_X); coord_array.push(z_8*general_config.cst_Z); coord_array.push(-y_8*general_config.cst_Y);
